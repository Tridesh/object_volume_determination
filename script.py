...
from imutils import perspective               # For perspective correction and point ordering
from imutils import contours                 # For contour sorting utilities
import numpy as np                           # For numerical operations and array handling
import imutils                               # Additional computer vision utilities
...
image_path = 'test1.png'      # Path to the input image
